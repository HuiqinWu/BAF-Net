...
class ResNet_late(nn.Module):
    def __init__(self, in_channel=1):
        super(ResNet_late, self).__init__()
    ...
    def forward(self, pet, ct):
        ...
        pet_output = self.output_head_pet(pet_vector)
        ct_output = self.output_head_ct(ct_vector)

        output = (pet_output * self.pet_weight + ct_output * self.ct_weight) / 2
